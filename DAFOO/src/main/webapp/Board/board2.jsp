...
<body>
  ...
  <path fill-rule="evenodd" d="M12.354 1.646a.5.5 0 0 1 0 .708L6.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
						...
						${(page.nowBlock * page.pagePerBlock) + cnt}//${page.totalRecord}
							<c:if test="${!doneLoop }">
								<c:if test="${(page.nowBlock * page.pagePerBlock) + cnt == page.totalPage-1}">
								...
								<a href="${context}/BoardList2.bo?bgroup=${bgroup}&nowBlock=${page.nowBlock}&nowPage=${(page.nowBlock*page.pagePerBlock)+cnt}" style="font-size:25px;">
								 ...
								 <c:if test="${(page.nowBlock*page.pagePerBlock)+1+cnt == page.totalRecord }">
								 	<c:set var="doneLoop" value="true"/>
								 </c:if>
							</c:if>
						</c:forEach>
